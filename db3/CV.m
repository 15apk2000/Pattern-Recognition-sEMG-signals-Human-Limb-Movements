...
addpath('/Academics/btp/data/classifiers/db3/');
...
if(filename(1:3)=="T-T")
    category = 1 ;
elseif (filename(1:3)=="I-I")
    category = 2 ;
elseif (filename(1:3)=="M-M")
    category = 3 ;
elseif (filename(1:3)=="R-R")
    category = 4 ;
elseif (filename(1:3)=="L-L")
    category = 5 ;
elseif (filename(1:3)=="T-I")
    category = 6 ;
elseif (filename(1:3)=="T-M")
    category = 7 ;
elseif (filename(1:3)=="T-R")
    category = 8 ;
elseif (filename(1:3)=="T-L")
    category = 9 ;
elseif (filename(1:3)=="HC-")
    category = 10 ; 
end
